...
mun heikkous
on etta mä oon ehkä liian kiltti
enkä osaa sanoa ei jos mulle annetaan lisätehtäviä
mikä saattaa johtaa sit ylitöihin sillon tällön -result in
...
mä nään itteni uuden kehitys yksikön -development unit
apulais päällikönä - deputy-assistant manager

sait työpaikan!

tassä oli siis kolme yleistä
työhaastattelu kysymystä
ja esimerkki vastauksia
joita voitte sit
