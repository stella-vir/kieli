'''
# lokakuu kaks kyt kaheksan
Se kuulostaa minusta tylsältä työltä, seuraa sitten sydäntäsi.
se voi tuntua jokus nyt vaikealta,
mutta se tarkoittaa myös että opit,
...
korkeintaan -max.
keskity vain siihen, mitä voit tehä,
mitä enemmän teet,
sitä parempi tulos
...
# lokakuu kaks kyt yheksan
mun täytyy myöntää -i have to admit
...
ahdistava -oppressive
se on yks terapian muoto -form of therapy
pakokeino -getaway a way to escape
